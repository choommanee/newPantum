...
class Product extends Model
{
    ...
    {
        return $this->hasMany(Driver::class, 'pro_id','id')
            ->orderBy('pro_id');
    }

    public function faqs()
    {
        return $this->hasMany(Faq::class, 'pro_id','id')
            ->orderBy('pro_id');
    }

    public function hasAnyDriver()
    {
        return $this->drivers->isNotEmpty();
    }

    public function hasAnyFaq()
    {
        return $this->faqs->isNotEmpty();
    }
