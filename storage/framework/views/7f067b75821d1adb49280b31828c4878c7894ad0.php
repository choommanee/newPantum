<?php $__env->startComponent('admin::components.page.header'); ?>
    <?php $__env->slot('title', trans('serials::serials.customer_register')); ?>

    <li class="active"><?php echo e(trans('serials::serials.customer_register')); ?></li>
    ...
    <?php $__env->startComponent('admin::components.table'); ?>
        <?php $__env->slot('thead'); ?>
            <tr>
                ...
                <th><?php echo e(trans('serials::serials.customer_register')); ?></th>
                <th>image s/n</th>
                ...
                { data: 'img_product', name: 'img_product' ,
                    "render": function ( data, type, row ) {
                        if(row['user_id']=='empty'){
                            ...
                            return '<img src="<?php echo e(url('/storage/media/warranty/')); ?>/'+row['img_product']+'" style="width: 100px;">';
                        }
