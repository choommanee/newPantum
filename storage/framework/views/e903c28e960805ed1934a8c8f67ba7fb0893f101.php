<div class="user-cart pull-right"  style="display: none">
    <div class="dropdown">
                        ...
                        <div class="mini-cart-item clearfix">
                            ...
                            <div class="mini-cart-details clearfix">
                                ...
                                <form method="POST" action="<?php echo e(route('cart.items.destroy', encrypt($cartItem->id))); ?>" onsubmit="return confirm('<?php echo e(trans('cart::messages.confirm')); ?>');">
                                    ...
                                    <button type="submit" class="cross-button" data-toggle="tooltip" data-placement="<?php echo e(is_rtl() ? 'right' : 'left'); ?>" title="<?php echo e(trans('storefront::layout.mini_cart.remove')); ?>">
