...
<div class="search-result-right pull-right">
    ...
    <div class="form-group showfillter" >
        <label><?php echo e(trans('storefront::products.filter')); ?></label>
    </div>
            ...
            <div class="grid-products separator">
                <?php if($viewMode === 'grid'): ?>
                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo $__env->make('public.products.partials.product_card1', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo e($products->links()); ?>
    ...
    <form id="frmSendCompare" method="POST" action="<?php echo e(route('compare.index')); ?>">
...
<?php $__env->startPush('styles'); ?>
    <style>
        ...
        #comparison .compare-hidden-toggle {
            ...
            background: url(<?php echo e(url('/themes/storefront/public/images/compare-arrow-1.png')); ?>) 50% 10px no-repeat #efefef;
        }
        ...
        #comparison .comparison-ul .item .close {
            ...
            width: 20px;
            height: 20px;
            background: url(<?php echo e(url('/themes/storefront/public/images/compare-close-btn.png')); ?>) 0 0 no-repeat;
            position: absolute;
        }
