  ...
  _createClass(ZoomPane, [{
    ...
    value: function setPosition(percentageOffsetX, percentageOffsetY, triggerRect) {
      var _this$imgEl$getBoundi = this.imgEl.getBoundingClientRect(),
          imgElWidth = _this$imgEl$getBoundi.width,
          imgElHeight = _this$imgEl$getBoundi.height;

      var _this$el$getBoundingC = this.el.getBoundingClientRect(),
          elWidth = _this$el$getBoundingC.width,
          elHeight = _this$el$getBoundingC.height;
