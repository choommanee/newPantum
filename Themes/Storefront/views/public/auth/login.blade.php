        ...
        <div class="col-md-6 detail-login" style="padding-left: 0px;padding-right: 0px;">
            <div class="form form-page" style="padding: 0px;">
                <div class="login form-inner clearfix" style="">
                    <div class="">
                        <div class="top-image" >
                            <img src="https://save2home.compublic/storage/media/logo.png" alt="" style="width: 300px;margin: auto auto; display: block;">
                        </div>
                        ...
                        <ul class="service-list">
                            <li class="service-item" style="list-style: none;">
                                <img class="service-icon" src="https://save2home.compublic/storage/media/sub_button.png" style="
    float: left;
    margin-top: 5px;
    margin-right: 10px;
">
