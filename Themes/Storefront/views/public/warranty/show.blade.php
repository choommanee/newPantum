...
@section('title', trans('serials::serials.warranty'))
        ...
        <section class="compare" style="background: #ffffff;margin-top: 30px;min-height: 600px;margin-bottom: 30px;">
            <div>
                <div class="blogNewsTitle">
                    <h1 style="float: left;background: #ffffff;">{{trans('serials::serials.warranty_title')}}</h1>
                ...
                <div class="uk-container">
                     ...
                     <div class="col-md-12" >
                         <div class="sections-title">
                             <div class="sections-title-h3"><h3 style=" margin: 24px;  color: #ee3733;     padding-bottom: 20px;">{{trans('serials::serials.warranty_title')}}</h3></div>
                            <span class="small-font" >{{trans('serials::serials.warranty_detail')}}</span>
                         </div>
                         <div>
                         <form method="GET" action="{{ route('warranty.index') }}" id="product-filter-form" class="form-faq">
