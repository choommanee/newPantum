        ...
        <section class="compare" style="background: #ffffff;margin-top: 30px;min-height: 600px;margin-bottom: 30px;">
            <div>
                <div class="blogNewsTitle">
                    ...
                    <form method="GET" action="{{ route('faqs.index') }}" id="product-filter-form" style="width: 45%;float: right;">
                        <input type="text"   name="Search" id="Search" placeholder="Search for names.." title="Type in a name" style="width: 78%;float: right;padding-left: 15px;">
